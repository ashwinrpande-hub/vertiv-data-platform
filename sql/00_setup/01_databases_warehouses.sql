...
CREATE OR REPLACE RESOURCE MONITOR VERTIV_DEMO_GUARD
...
ALTER WAREHOUSE ANALYTICS_WH SET RESOURCE_MONITOR = VERTIV_DEMO_GUARD;
ALTER WAREHOUSE ML_WH         SET RESOURCE_MONITOR = VERTIV_DEMO_GUARD;

-- ── 4. VERIFY ─────────────────────────────────────────────────
SHOW DATABASES LIKE 'VERTIV%';
