...
CREATE OR REPLACE TABLE VERTIV_ANALYTICS.ML_FEATURES.CUSTOMER_REVENUE_FEATURES (
...
CREATE OR REPLACE TABLE VERTIV_ANALYTICS.ML_FEATURES.PRODUCT_AFFINITY_FEATURES (
  FEATURE_ID            NUMBER        AUTOINCREMENT PRIMARY KEY,
  CUSTOMER_HK           VARCHAR(64)   NOT NULL,
...
CREATE OR REPLACE TABLE VERTIV_ANALYTICS.ML_FEATURES.MODEL_PREDICTIONS (
...
CREATE OR REPLACE TABLE VERTIV_ANALYTICS.AI.CUSTOMER_360_VECTORS (
...
CREATE OR REPLACE TABLE VERTIV_ANALYTICS.AI.PRODUCT_VECTORS (
...
CREATE OR REPLACE TABLE VERTIV_ANALYTICS.AI.CORTEX_SEARCH_INDEX (
...
-- ── GRANTS ────────────────────────────────────────────────────
GRANT SELECT ON ALL TABLES IN SCHEMA VERTIV_ANALYTICS.ML_FEATURES TO ROLE VERTIV_ML_ENGINEER;
GRANT SELECT ON ALL TABLES IN SCHEMA VERTIV_ANALYTICS.AI          TO ROLE VERTIV_ML_ENGINEER;
GRANT SELECT ON ALL TABLES IN SCHEMA VERTIV_ANALYTICS.AI          TO ROLE VERTIV_GLOBAL_ANALYST;
GRANT SELECT ON VERTIV_ANALYTICS.ML_FEATURES.MODEL_PREDICTIONS    TO ROLE VERTIV_GLOBAL_ANALYST;

-- ── VERIFY ────────────────────────────────────────────────────
SHOW TABLES IN SCHEMA VERTIV_ANALYTICS.ML_FEATURES;
SHOW TABLES IN SCHEMA VERTIV_ANALYTICS.AI;
SELECT COUNT(*) AS PRODUCT_ROWS FROM VERTIV_ANALYTICS.BI.DIM_PRODUCT;
SELECT COUNT(*) AS DATE_ROWS    FROM VERTIV_ANALYTICS.BI.DIM_DATE;
SELECT COUNT(*) AS REGION_ROWS  FROM VERTIV_ANALYTICS.BI.DIM_REGION;
